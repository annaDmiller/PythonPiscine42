...
def main():
    ...
    If the number of arguments is different from 1, or the type of any argument is wrong, prints AssertionError.
    """
    ...
    if size_args != 1 or not (args[0] != "" and all(ch == ' ' or ch.isalnum() for ch in args[0])):
